...
// 3. Retrieve major earthquakes GeoJSON data
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  
  // 4. Bring in the styleInfo function
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
  ...
  // 5. Bring in color by magnitude function
  function getColor(magnitude) {
    if (magnitude > 6) {
      return "#ea2c2c";
    }
  ...
  // 6. Bring in function that sets the radius of the marker based on magnitude
  function getRadius(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
